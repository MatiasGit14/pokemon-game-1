System.register('game_data/class/canvas/canvas', [], function(
  exports_1,
  context_1
) {
  'use strict';
      ...
      Draw = /** @class */ (function() {
        function Draw(target) {
          ...
          this.refresh = function() {
            return _this.ctx.clearRect(0, 0, 1200, 720);
          };
          this.buffer = {};
          this.bufferSize = 0;
        ...
        Draw.prototype.build = function() {
          ...
          bufferKeys.forEach(function(pixel) {
            return _this.draw(_this.buffer[pixel]);
          });
          this.buffer = {};
          this.bufferSize = 0;
        };
